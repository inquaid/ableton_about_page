  ...
  ` + ne + "}", Y
        ...
        switch (n.actionTypeId) {
            ...
            case ur: {
                let s = o(e, st),
                    u = o(e, ut),
                    f, h;
                return n.config.widthUnit === wt ? f = zh.test(s) ? parseFloat(s) : parseFloat(r.width) : f = (0, gt.default)(parseFloat(s), parseFloat(r.width)), n.config.heightUnit === wt ? h = zh.test(u) ? parseFloat(u) : parseFloat(r.height) : h = (0, gt.default)(parseFloat(u), parseFloat(r.height)), {
                    widthValue: f,
                    heightValue: h
                }
            }
    ...
    function uD(e, t, r, n, i, o) {
        ...
        switch (n.actionTypeId) {
            case ur: {
                ...
                f !== void 0 && (s === wt && (s = "px"), Ft(e, st, o), a(e, st, f + s)), h !== void 0 && (u === wt && (u = "px"), Ft(e, ut, o), a(e, ut, h + u));
                break
            }
            case Yr: {
                eD(e, r, n.config, o);
            ...
            case fr: {
                let s = Wa[n.actionTypeId],
                    ...
                    p = r.aValue;
                Ft(e, s, o), a(e, s, p >= 1 ? `rgb(${u},${f},${h})` : `rgba(${u},${f},${h},${p})`);
                break
            }
            default: {
                let {
            ...
            switch (t.type) {
                ...
                case xD: {
                    let {
                        ...
                        actionTypeId: $
                    } = i, J = qD($), te = MD(J, $), M = Object.keys(d).filter(q => d[q] != null && typeof d[q] != "string"), {
                        easing: O
                    } = i.config;
                    return (0, vt.set)(e, r, {
                        id: r,
    ...
    var jm, zm, Km, Ym, sk, uk, ck, lk, fk, dk, pk, gk, vk, hk, Ek, yk, mk, _k, bk, $m, Qm, Tk, Ik, Ok, Zm, wk, Ak, Jm, Sk, ys, e_, Gm, Um, t_, Jr, xk, ct, r_, Ck, ke, Ze, en, n_, ms, km, _s, Rk, Zr, Nk, Lk, Pk, i_, Vm, qk, Bm, Mk, Fk, Dk, Hm, _i, bi, Wm, Xm, o_, a_ = he(() => {
        ...
        Ym = le(Dt()), {
            ...
            let {
                type: n
            } = t.nativeEvent, i = [ys, e_].indexOf(n) !== -1 ? n === ys : r.isActive, o = {
                ...r,
                isActive: i
            };
            ...
            handler: qk((e, t) => {
                ...
                return !a[n.action.config.autoStopEventId] && t.triggered ? t : n.eventTypeId === Qm === r ? (ke(e), {
                    ...t,
                    triggered: !0
                }) : t
            })
                ...
                handler: ({
                    ...
                    switch (a) {
                        ...
                        case ot.PAGE: {
                            ...
                            m = _ ? Math.min(R + E, L) / L : Math.min(P + I, H) / H;
                            break
                        }
                        case ot.ELEMENT:
                        default: {
...
Webflow.require('ix2').init({
    "events": {
        "e-7": {
            ...
            "target": {
                "id": "66b5fff7a419bdef31540c9f|7ce5f194-fb7b-b466-79d2-e878aee4289f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [],
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 0,
                        "target": {
                            "selector": ".section.hide-show",
                            "selectorGuids": ["ec3c3868-8394-2e02-a2b5-1b5ffff15962", "213f22ee-4992-434e-eb58-efd21b7cc989"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".text.dropdown.minus",
                            "selectorGuids": ["b4a413c0-fbca-c11e-cd88-e2a49e30c95a", "8c1f12fc-fdfe-9a23-638f-1c1ca8bea553", "ec00b6b0-f01b-7a4d-149f-3912c5da7146"]
                        },
                        "value": "none"
                    }
                }, {
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".text.dropdown.plus",
                            "selectorGuids": ["b4a413c0-fbca-c11e-cd88-e2a49e30c95a", "8c1f12fc-fdfe-9a23-638f-1c1ca8bea553", "24b73314-d227-7729-3ca3-57bd35c95ec7"]
                        },
                        "value": "flex"
                    }
                }]
